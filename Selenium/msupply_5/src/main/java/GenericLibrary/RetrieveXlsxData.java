...
public class RetrieveXlsxData 
{
	...
	//Retrieving data from xlsx.sheet
		...
		else if(sheetName.equals("PipesFittings"))
		{
			       data=r.getCell(colNum).getStringCellValue();
			       System.out.println(data);
		}
		 ...
		 * @throws Exception 
		 */
		public void writeExcelData(String sheetName, int rowNum, int colNum, String data) throws IOException, Exception, InvalidFormatException
		{
		/* Get the file location*/	
		FileInputStream fis=new FileInputStream(filePath);
		 ...
		 * @throws Exception 
		 */
		public void rowCount(String sheetName) throws IOException, Exception, InvalidFormatException
		{
			/* Get the file location*/	
			FileInputStream fis=new FileInputStream(filePath);

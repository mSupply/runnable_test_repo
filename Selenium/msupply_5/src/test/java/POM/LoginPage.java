...
public class LoginPage 
{
	...
	public AddItemToCart navigateToInsideLoginPage() throws Exception 
	{
		...
		LoginButton.click();
		log.info("Clicked on Login Button");
		return PageFactory.initElements(Scenario1Test.driver, AddItemToCart.class);
	...
	public Object PlaceOrderToLoginPage(int option) throws Exception 
	{
        ...
        {
              case 0 :
       	         return PageFactory.initElements(Scenario1Test.driver, PaymentCreditCard.class);

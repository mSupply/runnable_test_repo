 ...
 */
class Clarion_PaymentModulePackbankin_Block_Form_Paymentmodulepack extends Mage_Payment_Block_Form
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('paymentmodulepackbankin/form/paymentmodulepack.phtml');
    }
}

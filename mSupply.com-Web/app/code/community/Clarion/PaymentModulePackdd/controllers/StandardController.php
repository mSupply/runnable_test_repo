...
class Clarion_PaymentModulePackdd_StandardController extends Mage_Core_Controller_Front_Action {
	...
	$this->_redirect('checkout/onepage/success/');
		...
		$customcard['action'] = Mage::getStoreConfig( 'payment/paymentmodulepackdd_checkout/submit_url' );
		$customcard['merchant_id'] = Mage::getStoreConfig( 'payment/paymentmodulepackdd_checkout/merchant_id' );
		$customcard['amount'] = round( $order->base_grand_total, 2 );
		$customcard['redirect_url'] = Mage::getBaseUrl() . 'paymentmodulepackdd_checkout/payment/response';
		...
		// Render layout
		//$this->loadLayout();
		//$block = $this->getLayout()->createBlock( 'Mage_Core_Block_Template', 'customcard', array( 'template' => 'paymentmodulepackdd/redirect.phtml' ) );

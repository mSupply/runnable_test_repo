...
class Mage_Catalog_Model_Category_Api extends Mage_Catalog_Model_Api_Resource
{
    ...
    ->addAttributeToSelect(array('brand','image','price','description','short_description','name','special_price','status'))
	->addAttributeToFilter('visibility', array('eq' => 4))->addAttributeToFilter('status', array('eq' => 1));

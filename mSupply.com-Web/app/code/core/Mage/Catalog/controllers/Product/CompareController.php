...
class Mage_Catalog_Product_CompareController extends Mage_Core_Controller_Front_Action
{
    ...
    public function addAction()
    {
		...
		$compareCollection = $collection = $this->getLayout()->createBlock('catalog/product_compare_list')->getItems();
		
		echo $compareCount = count($compareCollection);
		...
		{
		Mage::getSingleton('catalog/session')->addSuccess($this->__('Maximum four products can be added to comparison list'));	
		}
    ...
    public function clearAction()
    {
        ...
        try {
            $items->clear();
            $session->addSuccess($this->__('The comparison list has been cleared.'));
            Mage::helper('catalog/product_compare')->calculate();

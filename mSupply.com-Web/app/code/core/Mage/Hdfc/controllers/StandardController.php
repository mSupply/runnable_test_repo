...
class Mage_Hdfc_StandardController extends Mage_Core_Controller_Front_Action
{
    ...
    public function  successAction()
    {
		...
		Mage::getSingleton('core/session')->setTrackid($ResTrackID);
		Mage::getSingleton('core/session')->setPaymentid($ResPaymentId);
		Mage::getSingleton('core/session')->setTranid($ResTranId);

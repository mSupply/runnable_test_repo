 ...
 */
/**
 * Hdfc Configuration Model
 *
 * @category   Mage
 * @package    Mage_Hdfc
 * @name       Mage_Hdfc_Model_Config
 * @author     Magento Core Team <core@magentocommerce.com>
 */

class Mage_Hdfcdc_Model_Config extends Varien_Object
{
    /**
     *  Return config var
     *
    ...
    {
        if (!$this->hasData($key)) {
            $value = Mage::getStoreConfig('payment/hdfcdc_standard/'.$key);
 ...
 /**
    ...
    /**
     *  Return Store description sent to Hdfc
     *

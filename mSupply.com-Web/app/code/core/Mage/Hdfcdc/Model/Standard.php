 ...
 */
class Mage_Hdfcdc_Model_Standard extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'hdfcdc_standard';
    protected $_formBlockType = 'hdfcdc/standard_form';
    ...
    {
        return Mage::getSingleton('hdfcdc/config');
    }
    ...
    {
        return Mage::getUrl('hdfcdc/standard/success', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('hdfcdc/standard/notify', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('hdfcdc/standard/failure', array('_secure' => true));
    }
    ...
    {
        $block = $this->getLayout()->createBlock('hdfcdc/form_standard', $name);
    ...
    {
        return Mage::getUrl('hdfcdc/standard/redirect');
    }
    ...
    public function getStandardCheckoutFormFields ()
    {
        ...
        if ($this->getConfig()->getDescription()) {
            ...
            $transDescription = Mage::helper('hdfcdc')->__('Order #%s', $order->getRealOrderId());
        }
        ...
        $fields = array(       	
			...
			'return_url'	=> Mage::getUrl('hdfcdc/standard/success',array('_secure' => true)),

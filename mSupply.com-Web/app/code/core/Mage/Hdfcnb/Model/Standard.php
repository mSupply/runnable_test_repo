 ...
 */
class Mage_Hdfcnb_Model_Standard extends Mage_Payment_Model_Method_Abstract
{
    protected $_code  = 'hdfcnb_standard';
    protected $_formBlockType = 'hdfcnb/standard_form';
    ...
    {
        return Mage::getSingleton('hdfcnb/config');
    }
    ...
    {
        return Mage::getUrl('hdfcnb/standard/success', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('hdfcnb/standard/notify', array('_secure' => true));
    }
    ...
    {
        return Mage::getUrl('hdfcnb/standard/failure', array('_secure' => true));
    }
    ...
    {
        $block = $this->getLayout()->createBlock('hdfcnb/form_standard', $name);
    ...
    {
        return Mage::getUrl('hdfcnb/standard/redirect');
    }
    ...
    public function getStandardCheckoutFormFields ()
    {
        ...
        if ($this->getConfig()->getDescription()) {
            ...
            $transDescription = Mage::helper('hdfcnb')->__('Order #%s', $order->getRealOrderId());
        }
        ...
        $fields = array(       	
			...
			'return_url'	=> Mage::getUrl('hdfcnb/standard/success',array('_secure' => true)),

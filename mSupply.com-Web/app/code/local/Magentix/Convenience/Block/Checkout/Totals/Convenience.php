...
class Magentix_Convenience_Block_Checkout_Totals_Convenience extends Mage_Checkout_Block_Total_Default
{
    /**
     * Use your own template if necessary
     * See "checkout/total/default.phtml" for model
     */
    // protected $_template = 'convenience/checkout/total/Convenience.phtml';
}

...
class Msupply_Feedback_Block_Adminhtml_Feedback_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton(
            'save',
            'label',
            Mage::helper('feedback')->__('Save Item')
        );

        $this->_updateButton(
            'delete',
            'label',
            Mage::helper('feedback')->__('Delete Item')
        );

 ...
 */
/**
 * Havequestion REST API customer handler
 *
 * @category    Msupply
 * @package     Msupply_Havequestion
 * @author      Ultimate Module Creator
 */
class Msupply_Havequestion_Model_Api2_Havequestion_Rest_Customer_V1 extends Msupply_Havequestion_Model_Api2_Havequestion_Rest
{
    /**
     * current customer

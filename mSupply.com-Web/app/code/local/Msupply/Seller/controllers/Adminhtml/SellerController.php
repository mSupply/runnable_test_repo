...
class Msupply_Seller_Adminhtml_SellerController extends Mage_Adminhtml_Controller_action
{
    protected function _initAction()
    {
        $this->loadLayout()->_setActiveMenu('seller/items')->_addBreadcrumb(
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->_addContent(
                $this->getLayout()
                    ->createBlock('seller/adminhtml_seller_edit'))
                    ->_addLeft(
                        $this->getLayout()
                            ->createBlock('seller/adminhtml_seller_edit_tabs')
                    );

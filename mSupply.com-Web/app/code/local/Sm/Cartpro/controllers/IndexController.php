    ...
    {	//echo"abcdefge";die();
        ...
        try {
           ...
           // echo"die";die();
            ...
            if (!$this->_getSession()->getNoCartRedirect(true)) {
                if (!$cart->getQuote()->getHasError()){
                    $message = $this->__('%s was added to your shopping list.', Mage::helper('core')->htmlEscape($product->getName()));
           ...
           // echo"break1";die();
            ...
            $this->_getSession()->addException($e, $this->__('Cannot add the item to shopping list.'));
            $this->_goBack();
        }//echo"break";die();
        //echo"sorry";die();
		return true;

...
public class HomePage extends LoadLocators
{
	...
	@FindBy(xpath="(//div[@class='category-products']/following::div[@class='product-name'])[7]")
	...
	public static void SlidersVerification2() throws Throwable
	{
		 ...
		 for(int j=1;j<=8;j++)	
		 {
		     ...
		     for(int i=1;i<=15;i++)
			 {
		    	 ...
		    	 if(Price==0)
				  {
					   Scenario1Test.log.info("Price is displaying as Zero in Home Page");
					   throw new Exception();
				  }
		    	 if(Total==1||Total==16||Total==46||Total==61||Total==76||Total==91||Total==106)
				  {
...
public static void msupplyAboutusFooter() throws Throwable
{
		...
		{				
			if(i==0)
			{
				...
				String Title=Scenario1Test.driver.getTitle();
				Assert.assertEquals(Title, "mSupply");
				WebDriverCommonFunctions.element_Window_SwitchToParent("Switched to msupply Home Page");				

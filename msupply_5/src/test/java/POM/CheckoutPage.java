...
public class CheckoutPage 
{
	...
	@FindBy(xpath="//*[@id='opc-payment']/div[1]")
	...
	public void ToCreditCard() throws Exception
	{
		...
		Thread.sleep(10000);
		GenericLibrary.CommonFunctions.SwitchtoWebPage();
...
//	}
	...
	public double ServiceChargeCalculation(int PaymentMethod)
	{
        ...
        Total=SubTotal_p+ShippingandHandling_p+ShoppingCartPage.Service_Charges_calculated;
	...
	{        
    	...
    	Assert.assertEquals(SubTotal_payment_decimal, SubTotal_c.intValue());
		log.info("SubTotal Similar in Payment page and ConfirmOrder Page");
		Assert.assertEquals(ShippingandHandling_payment_decimal, ShippingandHandling_c.intValue());
		log.info("ShippingandHandling Similar in Payment page and ConfirmOrder Page");
		Assert.assertEquals(ServiceCharges_p_decimal, ServiceCharges_c.intValue());
		log.info("ServiceCharges Similar in Payment page and ConfirmOrder Page");
		Assert.assertEquals(Total_P.intValue(), Total_c.intValue());
		log.info("Grand Total Similar in Payment page and ConfirmOrder Page");
	}

	public void placeorder_Cheque() throws Throwable 
	{
	   WebDriverCommonFunctions.element_Click("AddressBilling_Xpath", "Clicked on Billing Address");
	   WebDriverCommonFunctions.element_Click("SaveAndContinueButton_Xpath", "Clicked on Save And Continue Button");
	   WebDriverCommonFunctions.element_Click("AddressShipping_Xpath", "Clicked on Shipping Address");
	   WebDriverCommonFunctions.element_Click("SaveAndContinueButton_Shipping_Xpath", "Clicked on Save And Continue Button");
	   WebDriverCommonFunctions.element_Click("ChequeOption_Xpath", "Selected Cheque option");
	   WebDriverCommonFunctions.element_Click("ChequeOption_ContinueButton_Xpath", "Clicked on Continue Button");
	   Thread.sleep(5000);
	   WebDriverCommonFunctions.element_Click("ConfirmOrderAndBuy_Xpath", "Clicked on ConfirmOrderQAndBuy");
